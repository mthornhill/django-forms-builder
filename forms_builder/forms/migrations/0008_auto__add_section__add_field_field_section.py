...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'forms_section', (
            ...
            ('form', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'sections', to=orm['forms.Form'])),
        ))
        db.send_create_signal(u'forms', ['Section'])

        # Adding field 'Field.section'
        db.add_column(u'forms_field', 'section',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'fields', null=True, to=orm['forms.Section']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Field.section'
        db.delete_column(u'forms_field', 'section_id')
    ...
    models = {
        u'forms.field': {
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'fields'", 'null': 'True', 'to': u"orm['forms.Section']"}),
